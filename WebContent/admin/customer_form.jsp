...
<body>
	...
	<div align="center">
		<c:if test="${customer != null }">
			<h2  class="pageheading">Update Customer</h2>
		</c:if>
		<c:if test="${customer == null}">
	...
	<div align="center">
		...
		<table class="from">
			...
			<tr>
				...
				<td align="left"><input type="email" name="email" id="email" size="45"
			...
			<tr>
				...
				<td align="left"><input type="text" name="phone"
					id="phone" size="45" value="${customer.phone}"></td>
			</tr>
			<tr>
				<td align="right">Address:</td>
				<td align="left"><input type="text" name="address"
					id="address" size = "45" value="${customer.address}"></td>
			</tr>
			<tr>
				<td align="right">City:</td>
				<td align="left"><input type="text" name="city"
					id="city" size = "45" value="${customer.city}"></td>
			</tr>
			<tr>
				<td align="right">Zip Code:</td>
				<td align="left"><input type="text" name="zipcode"
					id="zipcode" size = "45" value="${customer.zipcode}"></td>
			</tr>
			<tr>
				<td align="right">Country:</td>
				<td align="left"><input type="text" name="country"
					id="country" size = "45" value="${customer.country}"></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
